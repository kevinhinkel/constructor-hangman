...
var game = {
  firstRun: function() {
    console.log('\n');
    console.log('\x1b[44m%s\x1b[0m', ' Guess the Names of Animated Film Greats! ');
    console.log('\n');
    this.initGame();
  },
  secondRun: function() {
...
function printFilms() {
  ...
  var question = [
    {
      name: 'films',
      message: 'Would you like to see the full list of animated film greats?',
      type: 'list',
  ...
  inquirer.prompt(question).then(function(answer) {
    if (answer.films === 'Yes, I would') {
      /* 
        Wanted to invoke FilmName.prototype.printInfo() from word.js: 
